...
console.log("The sketch to be drawn is "+ quick_draw_data_set[random_number]);
sketch = quick_draw_data_set[random_number];
document.getElementById("input").innerHTML = "The sketch to be drawn is "+ quick_draw_data_set[random_number];
timer_count = 0;
timer_check = "";
drawn_sketch = "";
answer_holder = "";
...
function check_sketch(){
    ...
    document.getElementById("timer").innerHTML = "Timer : "+ Math.floor(timer_count/70);
    timer_count2 = Math.floor(timer_count/70);
    if(timer_count2 > 20){
        timer_count2 = 0;
        timer_count = 0;
